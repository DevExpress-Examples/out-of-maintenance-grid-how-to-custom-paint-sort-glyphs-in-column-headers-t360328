...
Namespace CustomDrawColumnHeader_SortButton
    Partial Public Class Form1
        ...
        Private Sub gridView1_CustomDrawColumnHeader(ByVal sender As Object,
            ByVal e As DevExpress.XtraGrid.Views.Grid.ColumnHeaderCustomDrawEventArgs) Handles gridView1.CustomDrawColumnHeader
        ...
        Private Shared Sub DrawCustomSortedShape(ByVal g As Graphics, ByVal r As Rectangle, ByVal so As ColumnSortOrder, ByVal imCol As ImageCollection)
